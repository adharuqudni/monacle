      ...
      <div className="max-w-7xl w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center justify-center">
          ...
          <div className="flex flex-col justify-center items-center md:items-start text-white text-center md:text-left">
            {/* Title & Arrows */}
            <div className="flex items-center justify-between w-full md:w-auto mb-6 gap-4">
              {/* Prev Button */}
              <button
                onClick={prevCase}
              ...
              {/* Title */}
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold whitespace-pre-line flex-1 text-center">
                {currentCase.title}
              </h2>
